  ...
  static const List<ColorSeedGroup> groups = [
    ColorSeedGroup(
      ...
      ColorSeedItem(
        name: '莓果色',
        nameEn: 'Berry',
        color: Color(0xFFBE3F70),
      ),
      ColorSeedItem(
        name: '洋红',
        nameEn: 'Magenta',
        color: Color(0xFFB33B74),
      ),
      ColorSeedItem(
        name: '李子紫',
        nameEn: 'Plum',
        color: Color(0xFFA855B7),
      ),
      ColorSeedItem(
        name: '薰衣草紫',
        nameEn: 'Lavender',
